...
import { selectCount, cancelCart } from "../../features/counter/counterSlice";
...
function CartComponent() {
  ...
  // const Submit = () => {
    ...
    }, [name,lastName,address,city,phone,email,zip])
  ...
  var sum = value.reduce((sum, product) => sum + product.price, 0);
        ...
        <>
          ...
          {value.length ? (
            <>
              ...
              <button onClick={Proceed} className="cartButtonItem">
                Proceed To Checkout
              </button>
            </>
          ) : (
        ...
        <>
          <div className="checkout">
            ...
            <div className="checkoutForm">
              ...
              <>
                <TextField
                  sx={{ width: matches === true ? "100%" :  "80%", marginBottom: "20px",backgroundColor:"White" }}
                  id="outlined-basic"
                  label="First Name"
                  value={name}
              ...
              {
                fail === true ? <p className="alertt" style={{color:"red",
              
        // fontSize:"20px",
      fontWeight:"bolder"}}>Please fill all the Fields</p> : null
              }
            ...
            <div className="checkoutBill">
              ...
              {value.map((elem) => {
                return (
                  <>
                    ...
                    <Divider
                      style={{ width: "80%", margin: "15px auto auto auto" }}
                    />
                  </>
                );
              })}
              ...
              {
                billError === true ?     <p className="alertt" style={{color:"red"}}> Please fill all the fields</p> : null

              }
          
              <button onClick={handleOrder} className="cartButtonPlace">
                Place Order
              </button>
              {paymentProceed === true ? (
                <p className="alertt" style={{ color: "Red" }}>
                  {" "}
